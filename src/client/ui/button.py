...
class Button:
    def __init__(
        ...
        text_font=None,
        parent=None,
        hover_text: str = "button.play.hover",
        click_text: str = "button.play.click",
        ...
        def command_extra():
            instance.audio_loader.load(
                "assets/sounds/wooden-impact.wav").play()
        ...
        if geom == None and overlay_img == None:
            ...
            geom = load_image_as_plane(
                instance, "assets/img/button_template.png", div_factor
            )
