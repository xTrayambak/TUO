...
class RPCManager:
    ...
    def run(self):
        log(
            "Rich presence started. Binding RPCManager._run to taskManager.",
            "Worker/RPCManager",
        )
        try:
        ...
        try:
            self.presence_client.update(
                ...
                buttons=[
                    {
                        "label": "Get the game!",
                        "url": "https://github.com/xTrayambak/TUO",
                    },
                    {
                        "label": "End User License Agreement",
                        "url": getAsset("links", "eula"),
                    },
                ],
            ...
            warn(
                "Discord RPC gateway shut down unexpectedly. Crash handled successfully!",
                "Worker/DiscordRPC",
            )
            return Task.done
